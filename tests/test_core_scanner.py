...
async def test_scan_with_compliance_frameworks(scanner, tmp_path):
    ...
    scanner = Scanner(enable_ai=True, compliance_frameworks=["cis", "nist"])
...
async def test_severity_threshold_filtering(tmp_path):
    ...
    scanner = Scanner(enable_ai=True, severity_threshold="high")
...
def test_scanner_initialization():
    ...
    scanner = Scanner(
        enable_ai=False, compliance_frameworks=["hipaa"], severity_threshold="high"
    )
