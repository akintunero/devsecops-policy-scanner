...
def sample_ai_analysis():
    ...
    return AIAnalysis(
        ...
        pattern_findings=[
            {"pattern": "insecure-config", "occurrences": 3, "severity": "high"}
        ],
        risk_predictions=[
            {"risk": "data-exposure", "probability": 0.75, "impact": "high"}
        ],
        behavioral_analysis={"risk_score": 0.8, "anomalies": ["suspicious-access"]},
        confidence_scores={"zero_day": 0.85, "pattern": 0.9, "risk": 0.75},
    )
